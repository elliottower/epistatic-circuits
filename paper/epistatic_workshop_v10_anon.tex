...
is. Weight-space geometry (OV and QK composition scores) carries no cross-validated predictive power for pairwise interaction, with no positive CV~$R^2$ in any condition, while a positive control on the same target and sample size returns CV~$R^2 = 0.20$. Edge Attribution
Patching agrees moderately (Spearman $\rho = 0.58$). Path patching, which isolates direct causal
