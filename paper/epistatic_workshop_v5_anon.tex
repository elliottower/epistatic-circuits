...
\begin{abstract}
A circuit is a claim that several components produce a behavior together, yet every discovery
method reports each component's importance alone. \citet{leemann2024slalom} prove that
...
20-head circuit. The decomposition is exact and reference-free. Circuits selected for functional
relevance carry 17--19\% of their coalition energy at order~2, against 2\% for randomly chosen head sets, and an additive summary discards all of it.
...
from fewer coalitions than there are coefficients ($r > 0.95$ at $M/k = 0.83$ for the 15-head
circuits and $0.67$ for the 20-head circuit). Each discovery method imposes a different selective
